# 🌿 Grass Hacker Premium 3.0

<div align="center">
  
  [English](#-grass-hacker-premium-30-english) | [Русский](#-grass-hacker-premium-30-russian)
  
</div>

---

## 🌿 Grass Hacker Premium 3.0 (English)

[![Version](https://img.shields.io/badge/version-3.0-brightgreen.svg)](https://github.com/DeftSolutions-dev/The-Last-Meadow-Discord)
...
<p align="center">Automatic assistant for playing grass in "The Last Meadow" on Discord.<br>Accelerates development several times over and eliminates all routine tasks!</p>
...
<table>
  <tr>
    <td>🖱️ <b>Auto-click</b></td>
    <td>Customizable speed up to 100 clicks per second</td>
  </tr>
  <tr>
    <td>🌿 <b>Auto-collect grass</b></td>
    <td>Instantly collects appearing grass with bonuses</td>
  </tr>
  <tr>
    <td>📈 <b>Auto-purchase upgrades</b></td>
    <td>Intelligent system for acquiring all available improvements</td>
  </tr>
  <tr>
    <td>🛒 <b>Auto-shop</b></td>
    <td>Automatically purchases items from the shop</td>
  </tr>
  <tr>
    <td>🏆 <b>Auto-level rewards</b></td>
    <td>Claims grass bonuses for leveling up</td>
  </tr>
  <tr>
    <td>🎁 <b>Auto-open lootboxes</b></td>
    <td>Instantly opens appearing lootboxes</td>
  </tr>
  <tr>
    <td>🚜 <b>Auto-lawnmower</b></td>
    <td>Activates the lawnmower bonus when it appears</td>
  </tr>
  <tr>
    <td>📊 <b>Statistics</b></td>
    <td>Tracking all actions in real time</td>
  </tr>
  <tr>
    <td>🔄 <b>Translation</b></td>
    <td>Built-in Russian to English translation</td>
  </tr>
</table>
...
2. Go to the "The Last Meadow" game tab
3. Start the game
4. Press <kbd>F12</kbd> or <kbd>Ctrl+Shift+I</kbd> to open Developer Tools in the game window
5. Go to the "Console" tab
6. Copy the contents of the file from GitHub via the link: [grass.hacker.js](https://raw.githubusercontent.com/DeftSolutions-dev/The-Last-Meadow-Discord/main/grass.hacker.js)
   (you may have to manually type "allow pasting" in the console if the code doesn't paste)
7. Paste the code into the console and press <kbd>Enter</kbd>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/DeftSolutions-dev/The-Last-Meadow-Discord/main/image.png" alt="Control Panel" width="400">
</p>

- **User-friendly control panel** with collapsible functionality
- **Status indicators** for each function (🟢 active / 🔍 searching)
- **Action counters** show the script's efficiency
- **Speed regulator** for customizing the auto-clicker to your needs
- **Global on/off** for quick control of all functions
- **Language switching** for comfortable use

### 🔧 Technical Details

- The script works entirely on the client side, without sending requests
- Uses user action emulation techniques
- Adaptive algorithms for optimal performance
- Optimized code with minimal browser load
- Real-time recognition of game element states
...
<p align="center">
  This script is intended for educational purposes only.<br>
  Using the script may violate the rules of the game and Discord.<br>
...
<p align="center">
  Made with ❤️ for grass enthusiasts in <b>The Last Meadow</b>
</p>
...
## 🌿 Grass Hacker Premium 3.0 (Russian)

[![Version](https://img.shields.io/badge/версия-3.0-brightgreen.svg)](https://github.com/DeftSolutions-dev/The-Last-Meadow-Discord)
...
<table>
  ...
  <tr>
    <td>🔄 <b>Перевод</b></td>
    <td>Встроенный перевод с русского на английский язык</td>
  </tr>
</table>
...
- **Переключение языка** для комфортного использования
